...
<div class="cb-login-modal cb-modal clearfix <?php echo $cb_menu_color; ?>">
    <div class="lwa lwa-default clearfix">
        <form class="lwa-form clearfix" action="<?php echo esc_attr(LoginWithAjax::$url_login); ?>" method="post">
            ...
            <div class="cb-form-body">
                <div class="cb-username"><i class="fa fa-user"></i><input type="text" class="cb-form-input-username" name="log" placeholder="<?php esc_html_e( 'Username', 'login-with-ajax' ); ?>"></div>
                ...
                <?php if ( get_option('users_can_register') && !empty($lwa_data['registration']) ) : ?>
                    <div class="cb-register">
                        <a href="#" class="cb-login-modal-closer cb-lwa-r-trigger" id="cb-lwa-r-trigger"><?php esc_html_e('Register','login-with-ajax') ?></a>
                    </div>
                <?php endif; ?>
           </div>
        </form>
...
<?php if( get_option('users_can_register') && !empty($lwa_data['registration']) ): ?>
	<div class="cb-register-modal cb-modal <?php echo $cb_menu_color; ?> clearfix">
