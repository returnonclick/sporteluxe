...
$(function(){
    $( '#wpbdp-listing-form-categories, #wpbdp-search-form' ).on( 'change', '.wpbdp-x-category-selector', function(e) {
        var $select = $(this);
...
$(function(){
    // Fix height for list of categories with images.
    var $category_lis = $( 'ul.wpbdp-categories.with-images > li' );
    $category_lis.height( Math.max.apply( null, $.map( $category_lis, function(x) { return $(x).height() } ) ) );
});
